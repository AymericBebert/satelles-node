...
export class Client {
    ...
    get lightService(): noble.Service | undefined {
        return this.services.find(s => s.uuid === LIGHT_SERVICE);
    }

    get lightCharacteristic(): noble.Characteristic | undefined {
        return this.characteristics.find(c => c.uuid === LIGHT_CHARACTERISTIC);
    }

    get brightnessCharacteristic(): noble.Characteristic | undefined {
        return this.characteristics.find(c => c.uuid === BRIGHTNESS_CHARACTERISTIC);
    }

    get temperatureCharacteristic(): noble.Characteristic | undefined {
        return this.characteristics.find(c => c.uuid === TEMPERATURE_CHARACTERISTIC);
    }

    get colorCharacteristic(): noble.Characteristic | undefined {
        return this.characteristics.find(c => c.uuid === COLOR_CHARACTERISTIC);
    }

    get settingsService(): noble.Service | undefined {
        return this.services.find(s => s.uuid === SETTINGS_SERVICE);
    }

    get lampNameCharacteristic(): noble.Characteristic | undefined {
    ...
    async setRGBColor(rgb: number[] | string | number | Buffer): Promise<void> {
    ...
    async setLampName(name: string): Promise<void> {
